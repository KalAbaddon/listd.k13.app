## little pause in adding checklists,  I think I have learned enugh to switch from this CMS to a static generator style( GRAV  is great and I love and is amazingly light whight,  this entire site been running on the free google GCE f1-micro "Micro machine type with 0.2 vCPU, 0.60 GB of memory, backed by a shared physical core." but it is still overkill) but now that I have been expermenting and learning I will be switching over to a static generator so that I can host it with out neededing a backend server.  It is just a list of lists,  the CMS is super overkill. This shouldnt take to long.  and i may still add checklists inbetween since worse cause senario I can still copy the lists between sites from what my research shows.
